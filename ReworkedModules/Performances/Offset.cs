...
namespace Evolve.Modules
{
    internal static class Offsets
    {
        ...
        private static IntPtr GetProcAddressSafe(IntPtr module, string name)
        {
            ...
            var result = SolverApi.GetProcAddress(module, name);
        ...
        {
            var ga = SolverApi.LoadLibraryA("GameAssembly.dll");
            ...
            SolverApi.SetPointersAndOffsets(ref icalls, ref colliderOffsets, ref boneOffsets, ref particleOffsets,
